...
class WeblinkServiceTest {
    ...
    //    private static final LinkService ls = new LinkService(); // without DI
    ...
    static void initAll() {
        ...
        linkRepository = mock(LinkRepository.class); // using mock repo for service initialisation
        ls = new LinkService(linkRepository);
    }
    ...
    @Test
        // parts after ampersand symbol should be returned
